...
namespace Daisy.Receivers.FootballEvent
{
    /// <summary>
    /// Event-based receiver for the Football workflow.
    /// Waits for a club name event raised by the Starter workflow and
    /// forwards the impulse to the Football workflow.
    /// </summary>
    public class FootballEventReceiver : AEventReceiver
    {
        /// <summary>
        /// Only runs on the Football workflow core.
        /// </summary>
        ...
        public FootballEventReceiver(IEnumerable<string> runOnCores)
        {
        ...
        /// <summary>
        /// Waits for a club name event and returns the queued impulse.
        /// </summary>
